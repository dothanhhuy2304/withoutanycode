...
public class OrderByDay {
    ...
    public OrderByDay(List<OrderDetail> detailList) {
    ...
    public void writeDataRow() {
        ...
        for (OrderDetail orderDetail : detailList) {
            ...
            if (getOrderDate.equals(getDateToday)) {
                ...
                cell = row.createCell(3);
                cell.setCellValue(getOrderDate);
                cell.setCellStyle(dataCellStyle);

                String getRequireDate = dateFormat.format(orderDetail.getOrder().getRequireDate());
                cell = row.createCell(4);
