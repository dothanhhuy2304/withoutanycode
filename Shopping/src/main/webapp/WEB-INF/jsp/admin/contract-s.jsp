                        ...
                        <div class="card">
                            ...
                            <div style="clear: both; width: 98%; margin: 10px auto;" class="">
                                ...
                                <form action="Shopping.com/admin/contract/search.htm" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-danger btn-fill waves-effect">
                                                    Tìm Kiếm
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <a type="button" href="Shopping.com/admin/contract/add-contract.htm"
                                       class="btn btn-success btn-fill pull-right">Thêm</a>
                                </div>
                                ...
                                <form:form action="Shopping.com/admin/contract/filter.htm" method="post">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-warning btn-fill waves-effect">
                                                Tìm kiếm
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach  items="${contractList}" var="contract" varStatus="iterStat">
                                        <tr>
                                            ...
                                            <td><fmt:formatNumber type="currency" value="${contract.subsidize }"
                                                                  pattern="###,###,###"/>VNĐ
                                            </td>
                                            <td><fmt:formatNumber type="currency" value="${contract.salary}"
                                                                  pattern="###,###,###"/>VNĐ
                                            </td>
                                            <td><fmt:formatNumber type="currency"
                                                                  value="${contract.salary +contract.subsidize}"
                                                                  pattern="###,###,###"/>VNĐ
                                            </td>
                                            <td>
                                                <c:choose>
                                            ...
                                            <td>
                                                <a href="Shopping.com/admin/contract/edit-contract/${contract.employee.id}.htm" type="button" class="btn btn-danger btn-xs">
                                                    Edit</a>
                                                <a href="Shopping.com/admin/contract/delete-contract/${contract.employee.id}.htm" type="button" onclick="return confirm('Bạn chắc chắn chứ ?')"
