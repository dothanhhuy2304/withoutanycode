...
<div class="main">
    <video id="video_background" preload="auto" autoplay="true"
        ...
        <source src="project/themes/login/video/life.mp4" type="video/webm">
            ...
            <div class="subscribe">
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 col-sm6-6 col-sm-offset-3 ">
                        <form:form class="form-inline" action="Shopping.com/admin/checkLogin" method="post"
                                   modelAttribute="admin" id="admin">
                            <div class="form-group">
                                <label class="sr-only">Username</label>
                                <label id="message-error">${message}</label>
                                <form:input id="username" path="username" placeholder="Please enter the username" value="dothanhhuy@gmail.vn" class="form-control transparent" />
                            </div>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <form:password id="password" path="password" placeholder="Please enter a password" value="dothanhhuy" class="form-control transparent" />
                            </div>
                            <br>
