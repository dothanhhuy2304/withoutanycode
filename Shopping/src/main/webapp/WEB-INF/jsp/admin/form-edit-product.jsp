                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form:form action="Shopping.com/admin/product/save-edit-product" method="POST" modelAttribute="product" enctype="multipart/form-data" id="product">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label> Tên Sản Phẩm: (<span style="color: red;">*</span>)
                                            <form:errors path="nameProduct" /></label>
                                        <form:input path="nameProduct" id="nameProduct" placeholder="Tên sản phẩm"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form:input path="unitPrice" id="unitPrice" placeholder="Đơn giá" size="30" maxlength="30"
