                        ...
                        <div class="card-block">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach items="${productList }" var="product" varStatus="iterStat">
                                        <tr>
                                            <td>${iterStat.count }</td>
                                            <td>${product.id }</td>
                                            <td width="200px">
                                                <a href="Shopping.com/admin/product/detail/${product.id }.htm">${product.nameProduct }</a></td>
                                            ...
                                            <td><a href="Shopping.com/admin/product/edit-product/${product.id }.htm"
                                                   class="btn btn-info btn-simple btn-sm">
                                                <i class="fa fa-edit"></i> Sửa</a>
                                                <br>
                                                <a href="Shopping.com/admin/product/detail/${product.id }.htm" class="btn btn-success btn-simple btn-sm">
                                                    Xem Chi Tiết
                                                </a>
                                                <br>
                                                <c:choose>
                                                ...
                                                onclick="return confirm('Bạn có chắc chắn rằng muốn chấp nhận sản phẩm ${product.nameProduct} này không?')">Duyệt Sản Phẩm</a>
                                                    </c:when>
                                                    <c:when test="${product.status == true}">
