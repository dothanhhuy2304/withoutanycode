                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <span class="pull-right" style="color:red;">${message}</span>
                            <br>
                            <form:form action="Shopping.com/admin/department/save-department" method="POST" modelAttribute="department" id="category">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form:input path="nameDepartment" id="nameDepartment" placeholder="Thể loại tiếng anh" size="30" maxlength="30" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
