                    ...
                    <div class="card">
                        <div class="card-block little-profile text-center">
                            ...
                            <div style="text-align: center;">
                                <form:form action="Shopping.com/employee/product/change-detail/${product.id }.htm"
                            ...
                            <!-- Thay Ảnh -->
                            <div style="text-align: center;">
                                <form:form id="products" action="Shopping.com/employee/product/changePhoto-detail/${product.id }.htm" method="POST" modelAttribute="product"
                            ...
                            <hr>
                            <a href="Shopping.com/employee/product"
...
<script type="text/javascript">
    $(function() {
        $("#products").validate({
            ...
            messages : {
                file_image : {
                    required : 'Vui lòng lựa chọn hình ảnh !'
                }
            }
        });
    });
