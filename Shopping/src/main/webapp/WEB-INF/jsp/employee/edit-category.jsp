                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <span class="pull-left" id="message">${message}</span>
                            <form:form action="Shopping.com/employee/category/saveEditCategory" method="POST" modelAttribute="category">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form:input path="nameCategory" placeholder="Hãy nhập thể loại" size="30" maxlength="30" class="form-control form-control-line" />
                                    </div>
                                    <div class="col-md-6">
                                        <label>Tên thể loại tiếng anh: (<span style="color: red;">*</span>)
                                            <form:errors path="nameCategoryEN" /></label>
                                        <form:input path="nameCategoryEN" placeholder="Thể loại tiếng anh" size="30" maxlength="30" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
