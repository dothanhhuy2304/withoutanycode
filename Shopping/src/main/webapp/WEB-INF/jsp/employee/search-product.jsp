                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach items="${productList }" var="product" varStatus="iterStat">
                                        <tr>
                                            ...
                                            <td>${product.id }</td>
                                            <td width="200px">
                                                <a href="employee/product/detail/${product.id }.htm">${product.nameProduct }</a></td>
                                            ...
                                            <td><a href="Shopping.com/employee/product/edit-product/${product.id }.htm"
                                                    class="btn btn-info btn-simple btn-sm">
                                                <i class="fa fa-edit"></i> Sửa</a>
                                                <br>
                                                <a href="Shopping.com/employee/product/detail/${product.id }.htm" class="btn btn-success btn-simple btn-sm">
